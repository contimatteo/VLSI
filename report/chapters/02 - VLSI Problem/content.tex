...
\subsection{Shared Notation} \label{sec:shared_variables}
    ...
    \subsubsection{Makespan lower bound}
        ...
        \end{equation*}
        The best situation is the one in which all circuits fit in a rectangle whose width=$width$ and height=$makespan$,
    ...
    \subsubsection{Makespan upper bound}
        ...
        A node must have enough free space on top to be a parent of another. Let $x$ be the circuit that 
